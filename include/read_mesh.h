...
//! ReadMesh class
//! \brief Class that returns mesh and particles locataions based on GMesh ascii
//! file \tparam Tdim Dimension
template <unsigned Tdim> class ReadMesh {
public:
  ...
  std::vector<std::vector<mfm::Index>> read_mesh_cells(const int id);
